...
productsRouter.post("/", async (req, res) => {
    ...
    const result = await PM.addProduct({title, description, code, price, status, stock, category, thumbnail}); 
...
productsRouter.put("/:pid", async (req, res) => {
    ...
    const result = await PM.updateProduct(pid, {title, description, code, price, status, stock, category, thumbnail});
